...
useEffect(() => {
  ...
  fetchCategories();
}, [page, dateFilter, selectedCategory, reporterName]);
...
const fetchForms = async (page) => {
  ...
  try {
    ...
    // Filter forms based on reporterName
    const filteredForms = data.forms.filter(form => form.reporterName === reporterName);
